...
for i in range(120):
    ...
    count2 = 0
    count3 = 0
random_book_count = [all_count[0], all_count[15], all_count[30], all_count[45], all_count[60], all_count[75], all_count[90], all_count[105], all_count[119]]
...
ws1 = wb.add_sheet("红楼梦结果")
ws1.write(0, 0, label="章节")
ws1.write(0, 1, label="x")
ws1.write(0, 2, label="y")
ws1.write(0, 3, label="z")
ws1.write(0, 4, label="类别")
for i in range(1, 121):
    ws1.write(i, 0, "第%d章" % i)
    ws1.write(i, 1, all_count[i-1][0])
    ws1.write(i, 2, all_count[i-1][1])
    ws1.write(i, 3, all_count[i-1][2])
    ws1.write(i, 4, "%s类" % outputLabel[i-1])
wb.save("红楼梦结果.xls")
